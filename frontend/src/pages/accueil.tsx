    ...
    <div
        ...
        <div className="container-style" style={{display: "flex"}}>
            <div className="container-accueil-image" style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
                    ...
                    <p style={{flexGrow: 1}}>Bienvenue sur la page officielle du Royaume MaxRemi! </p>
        ...
        <div className="flex flex-1 items-end justify-evenly gap-5 container-accueil-boutons">
            <Link to={"/connexion"} className="btn-nav degrade-rouge" style={{marginBottom: "4vh"}}>
            Connexion
            </Link>
            <Link to={"/inscription"}  style={{marginBottom: "4vh"}} className="btn-nav degrade-rouge">
            Inscription
            </Link>
        </div>
        )}
