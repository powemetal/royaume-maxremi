...
async function main() {
  ...
  const objetsData = [
    // ARMES
    {
      ...
      description: "Épée polyvalente utilisée par les soldats.",
    },
    {
    ...
    { nom: "Bouclier", rarete: "COMMUN", type: "BOUCLIER", def: 2, prix: 10 },
    ...
    // POTIONS
    {
      ...
      type: "POTION",
      prix: 50,
      description: "Restaure une petite quantité de vitalité.",
    },
    {
      nom: "Potion de soin supérieure",
      rarete: "PEU_COMMUN",
      type: "POTION",
      prix: 150,
    },
    {
      nom: "Potion de force de géant",
      rarete: "RARE",
      type: "POTION",
      prix: 300,
    },
    { nom: "Potion d'invisibilité", rarete: "RARE", type: "POTION", prix: 500 },

    // OUTILS
    { nom: "Kit d'herboriste", rarete: "COMMUN", type: "OUTIL", prix: 5 },
    { nom: "Kit de voleur", rarete: "COMMUN", type: "OUTIL", prix: 25 },
    { nom: "Kit d'alchimiste", rarete: "PEU_COMMUN", type: "OUTIL", prix: 50 },
    { nom: "Kit de calligraphie", rarete: "COMMUN", type: "OUTIL", prix: 10 },

    // MARCHANDISES
    { nom: "Lingot de fer", rarete: "COMMUN", type: "MARCHANDISE", prix: 3 },
    {
      nom: "Lingot d'argent",
      rarete: "PEU_COMMUN",
      type: "MARCHANDISE",
    ...
    { nom: "Lingot d'or", rarete: "RARE", type: "MARCHANDISE", prix: 50 },

    // SACS / CONTENEURS
    { nom: "Sac à dos", rarete: "COMMUN", type: "SAC", prix: 2 },
    { nom: "Petit sac", rarete: "COMMUN", type: "SAC", prix: 1 },
    { nom: "Bourse", rarete: "COMMUN", type: "SAC", prix: 1 },
    { nom: "Coffre en bois", rarete: "COMMUN", type: "CONTENEUR", prix: 5 },

    // BIJOUX
    { nom: "Anneau en argent", rarete: "COMMUN", type: "BIJOU", prix: 10 },
    { nom: "Collier en or", rarete: "PEU_COMMUN", type: "BIJOU", prix: 50 },
    { nom: "Bracelet en cuivre", rarete: "COMMUN", type: "BIJOU", prix: 5 },

    // TRINKETS
    { nom: "Pierre gravée", rarete: "COMMUN", type: "TRINKET", prix: 1 },
    { nom: "Petit totem en bois", rarete: "COMMUN", type: "TRINKET", prix: 2 },
    {
      nom: "Médaillon ancien",
      rarete: "PEU_COMMUN",
      type: "TRINKET",
      prix: 15,
    },
    ...
    {
      nom: "Parchemin de protection",
      rarete: "PEU_COMMUN",
      type: "PARCHEMIN",
      prix: 75,
    },
    {
      nom: "Parchemin de détection magique",
      rarete: "COMMUN",
      type: "PARCHEMIN",
      prix: 50,
    },
    ...
    { nom: "Baguette de feu", rarete: "RARE", type: "BAGUETTE", prix: 500 },
    { nom: "Baguette de glace", rarete: "RARE", type: "BAGUETTE", prix: 500 },
    {
      nom: "Focalisateur arcanique",
      rarete: "COMMUN",
      type: "FOCALISATEUR",
      prix: 10,
    },
    { nom: "Bâton de chêne", rarete: "COMMUN", type: "BATON", prix: 5 },

    // BOTTES / GANTS / CAPES / CASQUES
    { nom: "Bottes de cuir", rarete: "COMMUN", type: "BOTTES", prix: 5 },
    { nom: "Gants de cuir", rarete: "COMMUN", type: "GANT", prix: 2 },
    { nom: "Cape de voyage", rarete: "COMMUN", type: "CAPE", prix: 3 },
    { nom: "Casque de fer", rarete: "COMMUN", type: "CASQUE", prix: 10 },

    // OBJETS UTILITAIRES
    { nom: "Torche", rarete: "COMMUN", type: "AUTRE", prix: 1 },
    { nom: "Rations de voyage", rarete: "COMMUN", type: "AUTRE", prix: 5 },
    { nom: "Corde de chanvre (15m)", rarete: "COMMUN", type: "AUTRE", prix: 1 },
    { nom: "Marteau de forgeron", rarete: "COMMUN", type: "OUTIL", prix: 2 },
    { nom: "Piton", rarete: "COMMUN", type: "AUTRE", prix: 1 },
    { nom: "Lampe à huile", rarete: "COMMUN", type: "AUTRE", prix: 5 },
    { nom: "Huile (flasque)", rarete: "COMMUN", type: "AUTRE", prix: 1 },
    { nom: "Couverture", rarete: "COMMUN", type: "AUTRE", prix: 5 },
    { nom: "Bouteille en verre", rarete: "COMMUN", type: "AUTRE", prix: 2 },
    { nom: "Tente", rarete: "COMMUN", type: "AUTRE", prix: 10 },
    { nom: "Grappin", rarete: "COMMUN", type: "AUTRE", prix: 2 },
    { nom: "Sifflet", rarete: "COMMUN", type: "AUTRE", prix: 1 },
    { nom: "Carnet de notes", rarete: "COMMUN", type: "AUTRE", prix: 2 },
    { nom: "Plume et encre", rarete: "COMMUN", type: "AUTRE", prix: 1 },
    { nom: "Trousse de soins", rarete: "COMMUN", type: "OUTIL", prix: 5 },
    { nom: "Cadenas", rarete: "COMMUN", type: "AUTRE", prix: 10 },
    { nom: "Pelle", rarete: "COMMUN", type: "OUTIL", prix: 2 },
    { nom: "Poche à eau", rarete: "COMMUN", type: "AUTRE", prix: 1 },
    { nom: "Sablier", rarete: "COMMUN", type: "AUTRE", prix: 25 },
    { nom: "Trousse de messager", rarete: "COMMUN", type: "AUTRE", prix: 5 },
    { nom: "Trousse de cuisinier", rarete: "COMMUN", type: "OUTIL", prix: 1 },
    { nom: "Trousse de menuisier", rarete: "COMMUN", type: "OUTIL", prix: 8 },
    { nom: "Trousse de maçon", rarete: "COMMUN", type: "OUTIL", prix: 10 },
    { nom: "Trousse de brasseur", rarete: "COMMUN", type: "OUTIL", prix: 5 },
    { nom: "Trousse de tanneur", rarete: "COMMUN", type: "OUTIL", prix: 5 },
    { nom: "Trousse de peintre", rarete: "COMMUN", type: "OUTIL", prix: 10 },
    { nom: "Trousse de sculpteur", rarete: "COMMUN", type: "OUTIL", prix: 8 },
    { nom: "Trousse de potier", rarete: "COMMUN", type: "OUTIL", prix: 4 },
    { nom: "Trousse de pêche", rarete: "COMMUN", type: "OUTIL", prix: 1 },
    {
      nom: "Trousse de navigation",
      rarete: "PEU_COMMUN",
      type: "OUTIL",
      prix: 25,
    },
  ...
  const armes = objets.filter(
    (o) => o.type === "ARME" || o.type === "ARME_2_MAINS",
  );
  const armures = objets.filter(
    (o) => o.type === "ARMURE" || o.type === "BOUCLIER",
  );
  ...
  for (const perso of personnages) {
    ...
    const armureObligatoire =
      armures[Math.floor(Math.random() * armures.length)];
    ...
    for (const obj of objetsChoisis) {
      ...
      if (obj.id === armeObligatoire.id || obj.id === armureObligatoire.id)
        continue;
  ...
  // -----------------------------
  const queteNames = [
    "Les Ruines de Valmorra",
    "Le Cri du Bois Sombre",
    ...
    "Le Refuge des Mages",
    "La Route des Brumes",
    "Le Temple des Trois Lunes",
    "La Confrérie du Vent",
    "Le Sang du Titan",
    "La Marche des Loups",
    "Le Voile de Minuit",
    "La Cité Enfouie",
    ...
    "La Cour des Mirages",
    "Le Souffle du Mont Gris",
    "La Mer de Verre",
    "Le Dernier Rempart",
    "La Clé du Destin",
    "Le Chant du Fer",
    "La Nuit des Mille Lanternes",
    "Le Labyrinthe de Sel",
    "La Marche des Géants",
    "Le Serment de l’Aube",
    "La Chambre des Murmures",
    "Le Désert des Murmures",
    "La Lance du Soleil",
    "Le Tribut des Sables",
    "La Forteresse des Vents",
    "Le Puits des Ancêtres",
    "La Marche des Exilés",
    "Le Voile de l’Oasis",
    "La Cité des Mille Colonnes",
    "Le Souffle du Scorpion",
    "La Route des Caravanes",
    "Le Pacte des Nomades",
    "La Couronne de l’Aurore",
    "Le Tombeau des Premiers Rois",
    "La Danse des Mirages",
    "Le Serment des Marcheurs",
    "La Nuit des Trois Lunes",
    "Le Passage des Titans",
    "La Grotte du Croissant",
    "Le Chant des Dunes",
    "La Porte de l’Horizon",
    "Le Brasier du Sud",
    "La Faille des Ancêtres",
    "Le Refuge des Errants",
    "La Spirale de Verre",
    "Le Sablier du Destin",
  ];
  ...
  for (let i = 0; i < queteNames.length; i++) {
    const q = await prisma.quete.create({
      data: {
        nom: queteNames[i],
        difficulte: ["FACILE", "MOYEN", "DIFFICILE", "LEGENDAIRE"][
